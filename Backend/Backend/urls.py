...
from .views import IssueListView, UserDetailsView, SingleUser, SingleUserIssue, CityIssue, UserDetailsUpdateView, CityName
...
urlpatterns = [
    ...
    path('cityname/<str:name>', CityName.as_view(), name='city-name')
]
